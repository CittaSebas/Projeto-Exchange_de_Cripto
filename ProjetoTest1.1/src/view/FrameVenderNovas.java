 ...
 * @author Sebastian
 */
public class FrameVenderNovas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameVenderNovas
     */
    public FrameVenderNovas(String cpflogado) {
        initComponents();
        ...
        txtabv1.setEditable(false);
        txtabv2.setEditable(false);
        txtabv3.setEditable(false);
        ...
        txtsaldom1.setEditable(false);
        txtsaldom2.setEditable(false);
        txtsaldom3.setEditable(false);
    ...
    private void btncompra1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncompra1ActionPerformed
        ...
        controller.vendermoeda1(moeda1);
    ...
    private void btncompra2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncompra2ActionPerformed
        ...
        controller.vendermoeda2(moeda2);
        FrameUsuario fu = new FrameUsuario(cpflogado);
        fu.setVisible(true);
        dispose();
    ...
    private void btncompra3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncompra3ActionPerformed
        ...
        controller.vendermoeda3(moeda1);
        FrameUsuario fu = new FrameUsuario(cpflogado);
        fu.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameVenderNovas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
